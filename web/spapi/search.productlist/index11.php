...
if(isset($sign))
{
	...
	$sql="select id as ProductID,stock_id,c_num,online_num,price,mark_price from   
	...
	if(!empty($re))
	{
		...
		foreach($re as $k=>$de)
		{
			...
			$db->query("select   cname as name,hg_type as shop_type,con,rate,is_split,mz,max_num as num_max,gn,cf,gg,brand,country,warehouse_id,con
