...
<link href="media/css/bootstrap.min.css?v=<{$vsersion}>" rel="stylesheet" type="text/css"/>
<link href="media/css/bootstrap-responsive.min.css?v=<{$vsersion}>" rel="stylesheet" type="text/css"/>
<link href="media/css/font-awesome.min.css?v=<{$vsersion}>" rel="stylesheet" type="text/css"/>
<link href="media/css/style-metro.css?v=<{$vsersion}>" rel="stylesheet" type="text/css"/>
<link href="media/css/style.css?v=<{$vsersion}>" rel="stylesheet" type="text/css"/>
<link href="media/css/style-responsive.css?v=<{$vsersion}>" rel="stylesheet" type="text/css"/>
<link href="media/css/default.css?v=<{$vsersion}>" rel="stylesheet" type="text/css" id="style_color"/>
<link href="media/css/uniform.default.css?v=<{$vsersion}>" rel="stylesheet" type="text/css"/>
<link href="media/css/bootstrap-modal.css?v=<{$vsersion}>" rel="stylesheet" type="text/css"/>
<!-- END GLOBAL MANDATORY STYLES -->
<!-- BEGIN PAGE LEVEL STYLES -->
<link rel="stylesheet" type="text/css" href="media/css/select2_metro.css?v=<{$vsersion}>" />
<link rel="stylesheet" href="media/css/DT_bootstrap.css?v=<{$vsersion}>" />
