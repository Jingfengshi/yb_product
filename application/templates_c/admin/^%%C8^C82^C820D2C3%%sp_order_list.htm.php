<?php /* Smarty version 2.6.20, created on 2017-07-12 10:36:39
         compiled from sp_order_list.htm */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'site_url', 'sp_order_list.htm', 74, false),array('modifier', 'f_get_status', 'sp_order_list.htm', 138, false),)), $this); ?>
    ...
    <div class="span12">
      <div class="portlet box blue">
        <div class="portlet-title">
          <div class="caption"><i class="icon-search"></i>供应商订单搜素</div>
          <div class="tools"> <a href="javascript:;" class="collapse"></a> </div>
        </div>
        <div class="portlet-body" style="display: block;">
          <div id="sample_1_wrapper" class="dataTables_wrapper form-inline" role="grid">
            <form action="" method="get" onsubmit="return load_sub();" id="form1">
...
?>
                     <option <?php if (isset ( $_GET['search_delivery_status'] ) && $_GET['search_delivery_status'] == $this->_tpl_vars['k'] && $_GET['search_delivery_status'] != 'all'): ?>selected = "selected"<?php endif; ?> value = "<?php echo $this->_tpl_vars['k']; ?>
...
">
                      <span class="add-on"><i class="icon-calendar"></i></span> </div>
                      <button class="btn red reconciliation" data-action="reconciliation"  data-url="<?php echo ((is_array($_tmp='order/reconciliation_no')) ? $this->_run_mod_handler('site_url', true, $_tmp) : site_url($_tmp)); ?>
"  type="button">生成对账号</button>
                  </div>
                </div>
              </div>
              <div class="row-fluid" style="margin-top:20px; "> <span class="span1" style="display:block;">
    ...
    foreach ($_from as $this->_tpl_vars['k'] => $this->_tpl_vars['v']):
?> <option <?php if (isset ( $_GET['search_reconciliation_status'] ) && $_GET['search_reconciliation_status'] == $this->_tpl_vars['k'] && $_GET['search_reconciliation_status'] != 'all'): ?>selected = "selected"<?php endif; ?> value = "<?php echo $this->_tpl_vars['k']; ?>
"><?php echo $this->_tpl_vars['v']; ?>
                  ...
                  <span class="span1" style="display:block;">
                <div id="span_label">对账单号</div>
                </span>
                  <div class="span6" style="margin-left:0px;">
                      <input type="text"  name="search_reconciliation_no"   value="<?php echo $_GET['search_reconciliation_no']; ?>
" class="m-wrap small"/>
                      <button class="btn red " style="margin-left: 25px;" onclick="return confirm('确认导出数据吗');" name="export" type="submit">导出对账单</button>
                      <button class="btn red "  onclick="return confirm('确认导出数据吗');" name="export1" type="submit">导出核算单</button>
                  </div>
              </div>
              ...
              <table class="table table-striped table-bordered table-hover dataTable" id="product_1" >
                <thead>
                  <tr role="heading">
                    ...
                    <th width="100" class="sorting_disabled" role="columnheader" tabindex="0" aria-controls="sample_1">订单号</th>
                    ...
                    <th width="120" class="sorting_disabled" role="columnheader" tabindex="0" aria-controls="sample_1">对账号</th>
                    ...
                    <th width="120" class="sorting_disabled" role="columnheader" tabindex="0" aria-controls="sample_1">收货人手机</th>
                    <th  width="120" class="sorting_disabled" role="columnheader" tabindex="0" aria-controls="sample_1">收货人姓名</th>
                    <th width="*" class="sorting_disabled" role="columnheader" tabindex="0" aria-controls="sample_1">收获地址</th>
...
?>
                <tr >
                  <td><button type="button" data-action="check_info" data-id="<?php echo $this->_tpl_vars['item']['id']; ?>
" data-box-size="800|300" class="btn mini blue order_detail">查看</button></td>
                  ...
                  <td><?php echo $this->_tpl_vars['item']['reconciliation_no']; ?>
</td>
            ...
            if(action=='check_info')
            {
                $(this).on('click', function(){
                    ...
                    setTimeout(function(){
                        ...
                        $modal.load("<?php echo ((is_array($_tmp='order/sp_order_info')) ? $this->_run_mod_handler('site_url', true, $_tmp) : site_url($_tmp)); ?>
?id="+ select_id, '', function(){
    ...
    {
        $('.reconciliation').bind('click',function(){
            $modal=$('#ajax-modal');
            $('body').modalmanager('loading');
            ...
            var action=$(this).attr('data-action');
            $.post(url,$('#form1').serialize(),function(msg){
                try
                {
                   // alert(msg);
                    eval("var str="+msg);
