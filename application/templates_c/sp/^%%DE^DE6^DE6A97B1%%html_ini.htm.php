<?php /* Smarty version 2.6.20, created on 2017-07-12 14:35:03
         compiled from D:%5Cphpstudy%5CWWW%5Cyb_product%5Capplication%5Ctemplates/sp/html_ini.htm */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'site_url', 'D:\\phpstudy\\WWW\\yb_product\\application\\templates/sp/html_ini.htm', 108, false),)), $this); ?>
<!DOCTYPE html>
...
function modal_iframe(mothed,title,width,height,value)
{
   ...
   $('body').modalmanager('loading');
	setTimeout(function(){
	 $modal1.load('<?php echo ((is_array($_tmp="sp_index/iframe")) ? $this->_run_mod_handler('site_url', true, $_tmp) : site_url($_tmp)); ?>
